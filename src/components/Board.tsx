...
import { strays, tidySummary, unusedLeavers } from '../store/tidyLeavers'
      ...
      <div className="app">
        ...
        <div className="layout">
          <RosterPanel
            ...
            strays={strays(data).length + unusedLeavers(data).length}
            onTidy={() => {
              if (window.confirm(tidySummary(data))) store.tidyLeavers()
            }}
